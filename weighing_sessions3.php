...
$first_section_sql = "SELECT section_id, section_name FROM sections WHERE grade_id = 4 ORDER BY section_id LIMIT 1";
            ...
            <div class="d-flex justify-content-between align-items-center">
               <div class="form-group">
                  ...
                  <?php
                     ...
                     $section_sql = "SELECT section_id, section_name FROM sections WHERE grade_id = 4";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteSectionsForm" method="POST" action="delete_sections.php">
                    ...
                    $result = $conn->query("SELECT section_id, section_name FROM sections WHERE grade_id = 4");
